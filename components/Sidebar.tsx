            ...
            {!userProfile && (
              <div className='px-2 py-4 hidden xl:block'>
                ...
                <div className='pr-4'>
                  ...
                  clientId=''
                  render={(renderProps) => (
                    <button className='bg-white text-lg text-[#F51997] cursor-pointer border-[1px] border-[#F51997] font-semibold px-6 py-3 rounded-md outline-none w-full mt-3 hover:text-white hover:bg-[#F51997]'
